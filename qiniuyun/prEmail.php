                ...
                <div class="side-bar">
                    <ul class="topnav menu-left-nest">
                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="#" title="Blog List"><i class="entypo-doc-text"></i><span>t--1</span></a>
                                </li>
                                <li>
                                    <a class="tooltip-tip2 ajax-load" href="#" title="Blog Detail"><i class="entypo-newspaper"></i><span>t--2</span></a>
                                </li>
                            </ul>
                        </li>
                        <li>
    ...
    <div class="wrap-fluid">
        <div class="container-fluid paper-wrap bevel tlbr">
            ...
            <ul id="breadcrumb">
                ...
                <li><a href="#" title="Sample page 1">基于云存储的NPO数据共享平台</a>
                </li>
                <li><i class="fa fa-lg fa-angle-right"></i>
                </li>
                <li><a href="#" title="Sample page 1">发送邮件</a>
                </li>
                <li class="pull-right">
                        ...
                        <div class="nest" id="basicClose">
                            ...
                            <div class="body-nest" id="basic">
                                <div class="form_center">
                                    <form role="form" id="sendemail" method="post" action="toEmail.php"
                                                        enctype="multipart/form-data">

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Email address</label>
                                            <input type="email" placeholder="Enter email" id="receiver" name="receiver" class="form-control">
            ...
            <div id="footer">
                ...
                <div class="copyright">Make with Love
                    <span class="entypo-heart"></span>Collect from <a href="#" title="主页" target="_blank">主页</a> All Rights Reserved</div>                <div class="devider-footer"></div>
